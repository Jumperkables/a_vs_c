#!/bin/bash
#SBATCH -p part0
#SBATCH --job-name vi_glove_imaggt500 
#SBATCH --ntasks 5
#SBATCH --gres gpu:1 
#SBATCH -o vi_glove_imaggt500.out
...
python -W ignore ../../tvqa_modality_bias/main.py \
    ...
    --jobname=nstpwrds_vi_glove_imaggt500 \
    --results_dir_base=vi_imaggt500 \
    ...
    --lanecheck_path vi_imaggt500/lanecheck_dict.pickle 

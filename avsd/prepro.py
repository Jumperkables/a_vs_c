...
# Input files
parser.add_argument('-input_json_train', default='../data/AVSD/qa_and_options/train_options.json', help='Input `train` json file')
parser.add_argument('-input_json_val', default='../data/AVSD/qa_and_options/val_options.json', help='Input `val` json file')
...
if __name__ == "__main__":
    ...
    print('Reading json...')
    args.input_json_train = resolve_path(args.input_json_train)
    args.input_json_val = resolve_path(args.input_json_val)

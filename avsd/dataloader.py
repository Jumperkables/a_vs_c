...
class VisDialDataset(Dataset):
    ...
    def __init__(self, args, subsets):
        ...
        self.args = args
        ### Resolve paths
        args.input_img  = resolve_path(args.input_img)
        args.input_vid  = resolve_path(args.input_vid)
        args.input_audio= resolve_path(args.input_audio)
        args.input_ques = resolve_path(args.input_ques)
        args.input_json = resolve_path(args.input_json)
        ####
            ...
            for th_id in range(num_convs):
                ...
                for round_id in range(num_rounds):
                    if round_id == 0:
                        ...
                        history[th_id][round_id][:min(40, max_ques_len + max_ans_len)] = captions[th_id][:max_ques_len + max_ans_len]
                    else:
